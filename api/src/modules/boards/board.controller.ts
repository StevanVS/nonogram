...
export const createBoard: RequestHandler = async (req, res) => {
  ...
  try {
    const result = await BoardModel.create(validReq.data);
    ok(res, result);
  } catch (error) {
    serverError(res);
  }
...
export const updateBoard: RequestHandler = async (req, res) => {
  ...
  try {
    const result = await BoardModel.findOneAndUpdate(query, validReq.data);
    ok(res, result);
  } catch (error) {
    serverError(res);
  }
...
export const deleteBoard: RequestHandler = async (req, res) => {
  ...
  try {
    const result = await BoardModel.findOneAndDelete(query);
    ok(res, result);
  } catch (error) {
    serverError(res);
  }
